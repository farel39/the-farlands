...
const DEFS: Dictionary = {
	...
	"brood_mother": {
		...
		"render_scale": 3.0,
		"drops": [
			{"item": "Stalker Fang", "min": 2, "max": 4, "chance": 1.0},
			{"item": "Crawler Hide", "min": 2, "max": 3, "chance": 1.0},
			{"item": "Strange Egg",  "min": 1, "max": 2, "chance": 1.0},
			{"item": "Bioluminescent Algae", "min": 2, "max": 4, "chance": 1.0},
		],
	},
}
